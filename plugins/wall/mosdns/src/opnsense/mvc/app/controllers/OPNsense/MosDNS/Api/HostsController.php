...
class HostsController extends ApiMutableModelControllerBase
{
    ...
    /**
     * Get hosts plugin configurations
     * @return array
     */
    public function getAction()
    {
        ...
        if ($this->request->isGet()) {
            $mdl = $this->getModel();
            $result['hosts'] = $mdl->hosts->getNodes();
        }
        return $result;
    }

    /**
     * Get specific hosts plugin by UUID
    ...
    public function getItemAction($uuid = null)
    {
        $mdl = $this->getModel();
        if ($uuid != null) {
            $node = $mdl->getNodeByReference('hosts.plugin.' . $uuid);
            if ($node != null) {
                return array('hosts' => $node->getNodes());
            }
        }
        return array();
    }
    ...
    public function addItemAction()
    {
        ...
        if ($this->request->isPost()) {
            $mdl = $this->getModel();
            $node = $mdl->hosts->plugin->Add();
            $node->setNodes($this->request->getPost('hosts'));
    ...
    /**
     * Toggle hosts plugin enabled/disabled
     * @param string $uuid item unique id
     * @return array
     */
    ...
    /**
     * Search hosts plugins
     * @return array
     */
    public function searchItemAction()
    {
        return $this->searchBase('hosts.plugin', array('enabled', 'tag', 'files'));
    }
}