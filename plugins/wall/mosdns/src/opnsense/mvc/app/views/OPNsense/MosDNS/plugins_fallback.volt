    ...
    <table id="grid-fallback" class="table table-condensed table-hover table-striped" data-editDialog="dialog_fallback">
        <thead>
            <tr>
                ...
                <th data-column-id="primary" data-width="20em" data-type="string">{{ lang._('Primary') }}</th>
                <th data-column-id="secondary" data-width="20em" data-type="string">{{ lang._('Secondary') }}</th>
